...
{
    Task<IEnumerable<UserResponse>> GetAllUsersAsync(string? status = null, CancellationToken cancellationToken = default);
    ...
    Task<UserResponse> DeleteUserAsync(int userId, CancellationToken cancellationToken = default);
