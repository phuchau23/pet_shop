...
namespace FoodBooking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260227073045_UpdatePaymentToZaloPay")]
    partial class UpdatePaymentToZaloPay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodBooking.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("ZaloPayAppTransId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("zalopay_app_trans_id");

                    b.Property<string>("ZaloPayOrderId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("zalopay_order_id");

                    b.Property<string>("ZaloPayPaymentUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("zalopay_payment_url");

                    b.Property<string>("ZaloPayQrCodeUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("zalopay_qr_code_url");
